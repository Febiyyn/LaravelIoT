...
<div class="container d-flex justify-content-between mt-4">
    <form method="POST" action="/sensor/update/{{ $sensor->id }}">
        ...
        <div class="mb-3">
            ...
            id="nama_sensor" value="{{ old('nama_sensor', $sensor->nama_sensor) }}" name="nama_sensor">
            @error('nama_sensor')
        ...
        <div class="mb-3">
            ...
            id="data"  value="{{ old('data', $sensor->data) }}" name="data">
            @error('data')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
        </div>
        <div class="mb-3">
            ...
            id="topic"  value="{{ old('topic', $sensor->topic) }}" name="topic">
            @error('data')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
        </div>
